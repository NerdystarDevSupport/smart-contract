...
contract NationValueChip is ERC1155LUXON {

    address private valueChipDataAddress;
    DspValueChipData.ValueChipsType private valueChipType = DspValueChipData.ValueChipsType.Class;

    constructor(
        address _valueChipDataAddress,
        string memory operator,
        address luxOnAdmin
    ) ERC1155LUXON("Desperado: Value Chip", "Nation", '', operator, luxOnAdmin) {
