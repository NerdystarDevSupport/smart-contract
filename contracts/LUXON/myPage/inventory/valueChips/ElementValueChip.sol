...
contract ElementValueChip is ERC1155LUXON {

    address private valueChipDataAddress;
    DspValueChipData.ValueChipsType private valueChipType = DspValueChipData.ValueChipsType.Element;

    constructor(
        address _valueChipDataAddress,
        string memory operator,
        address luxOnAdmin
    ) ERC1155LUXON("Desperado: Value Chip", "Element", '', operator, luxOnAdmin) {
